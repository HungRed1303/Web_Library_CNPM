      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-black bg-opacity-70 rounded-xl border border-pink-500 shadow-[0_0_15px_rgba(255,105,180,0.5)] z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1">
            <label htmlFor="username" className="text-white font-medium" style={{ fontFamily: "Tahoma, sans-serif" }}>
              Username
            </label>
            <input
              id="username"
          ...
          <div className="space-y-1">
            <label htmlFor="name" className="text-white font-medium" style={{ fontFamily: "Tahoma, sans-serif" }}>
              Name
            </label>
            <input
              id="name"
          ...
          <div className="space-y-1">
            <label htmlFor="confirmPassword" className="text-white font-medium" style={{ fontFamily: "Tahoma, sans-serif" }}>
              Confirm Password
            </label>
            <div className="relative">
              <input
