...
const {getAllStudent,getStudentById,deleteStudent,updateStudent,getStudentByUserId } = require("../controllers/studentController");
...
router.get("/user-id/:id",getStudentByUserId)
