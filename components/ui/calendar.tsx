    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-pink-500 text-white",
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-white hover:bg-pink-900",
        ),
        day_range_end: "day-range-end",
        day_selected: "bg-pink-600 text-white hover:bg-pink-700 hover:text-white focus:bg-pink-700 focus:text-white",
        day_today: "bg-gray-800 text-white border border-pink-500",
        day_outside:
